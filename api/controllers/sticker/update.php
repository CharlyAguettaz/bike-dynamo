...
if ($_SERVER['REQUEST_METHOD'] === "POST") {
    ...
    if ($token != null && JWTUtils::authorizeToken($user, $token)) {
        ...
        if (!empty($_POST['id']) && !empty($_POST['last_name']) && !empty($_POST['first_name']) && !empty($_POST['concert_date']) && !empty($_POST['concert_place']) && !empty($_POST['concert_description'])) {
            ...
            $result = $musician->updateMusician();
